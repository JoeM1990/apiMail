...
let MailController = class MailController {
    ...
    async sendEmail(to, fromName, subject, text) {
        return this.mailService.sendMail(to, fromName, subject, text);
    }
    async sendEmailMultiple(to, fromName, subject, text) {
...
__decorate([
    ...
    __param(1, (0, common_1.Body)('fromName')),
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], MailController.prototype, "sendEmailMultiple", null);
